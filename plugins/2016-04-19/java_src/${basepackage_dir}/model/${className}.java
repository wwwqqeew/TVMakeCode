...
public class ${className} extends BaseEntity {
	...
	//alias
	public static final String TABLE_ALIAS = "${table.columns[0].columnAlias}";
	...
	public static final String FORMAT_${column.constantName} = ${column.jdbcSqlTypeName}_FORMAT;
	</#if>
	</#list>
