							...
							<#list table.columns as column>
							 <#if !column.pk>
							  <@htm column=column function="radio_df">
								 ...
								 <td class="right"><label style="width: 312px">${'$'}{${classNameLower}.${column.columnNameLower}}</label></td>
							    </tr>
							  </@htm>
							 ...
							 <@htm column=column function="datetime">
								<tr class="user-remove">
								<td class="left"><#if !column.null><span class="iframe-not-null">*</span></#if>${htm_notes(column)}：</td>
								<td class="right"><label style="width: 312px">${'$'}{${classNameLower}.${column.columnNameLower}}</label></td>
								</tr>
							</@htm>
