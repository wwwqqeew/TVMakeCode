...
(function($, exports) {
	var ${className}Module = new exports.Modle("${classNameLower}Main","${classNameLower}management","edit${classNameLower}","${classNameLower}-table");
	//debugger;
	//构建获取的每一行
	...
	window.${className}Module = ${className}Module;
