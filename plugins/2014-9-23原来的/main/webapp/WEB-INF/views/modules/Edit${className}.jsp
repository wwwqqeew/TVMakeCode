...
<body>
	<form id='edit-${classNameLower}-form' class="iframe-form">
		...
		<tr class="iframe-button-tr">
					<td align="center"><input value="保存" class='iframe-button save-edit-${classNameLower} iframe-radius'
						type="button"></input><input type="hidden" class='<#list table.columns as column><#if (column.pk)>${column.columnNameLower}</#if></#list>' ></td>
					<td align="center"><input value="取消" class='iframe-button cancel-edit-${classNameLower} iframe-radius'
