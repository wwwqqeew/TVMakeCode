...
public class Column {
	 ...
	 */
	private final String _decodeUnicode;
	
	private final String _nowDate;
...
//	String validateString;
	...
	public Column(Table table, int sqlType, String sqlTypeName,
			...
			String defaultValue,String remarks,String decodeUnicode,String nowDate) {
		_table = table;
		_sqlType = sqlType;
		_sqlName = sqlName;
		...
		_remarks = remarks;
		_isNull = isNullable;
		_decodeUnicode = decodeUnicode;
		_nowDate = nowDate;
//		System.out.println("8888888888888888888888888888:"+_isNull);
	 ...
	 * @return
	 */
	public String getdecodeUnicode(){
		return _decodeUnicode;
	}
 ...
 * @return
 */
	public boolean getIsComid() {
		boolean b = true;
		if(getColumnNameLowerCase().equals("comid")){
			b = false;
		}
		return b;
	}
